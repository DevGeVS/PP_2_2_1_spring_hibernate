...
import hiber.service.model.Car;
...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        User user1 = new User("Ivan", "Ivanov", "john@gmail.ru");
        User user2 = new User("Petr", "Petrov", "jane@gmail.ru");
        ...
        if (foundUser != null) {
            ...
            System.out.println("такого users нет");
        }
